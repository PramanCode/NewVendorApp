...
export default class ItemsList extends Component {
    ...
    return {
      headerRight: (
        <View>
         {/*  <MaterialIcons
            name="more-vert"
            onPress={() => navigation.getParam('onMenuPressed')}
            style={{ marginRight: 10, color: 'black' }}
            size={30}
          /> */}
          <HeaderButtons
            HeaderButtonComponent= {()=> {<HeaderButton IconComponent={Ionicons} iconSize={23} color="blue" />}}
          ...
          >
            ...
            <HiddenItem
              title="View Orders"
              onPress={() => navigation.navigate('OrdersList',{'restaurantKey':navigation.getParam('restaurantKey')})}
              show="never"
            />
            <Item
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      categoryArr: [],
      iconsDropdownModalVisible:false
    };
    this.categoryName = "";
    this.categoryKey = "";
    ...
    this.renderIconsDropdownModal = this.renderIconsDropdownModal.bind(this);
    ...
    this.iconsDropdownModalHandler = this.iconsDropdownModalHandler.bind(this);
  ...
  iconsDropdownModalHandler(e) {
    //e.preventDefault();
    this.setState({
      iconsDropdownModalVisible: true
    });
  }

  renderIconsDropdownModal(){
    return(
      <View>
        <Text>Edit</Text>
        <Text>Add</Text>
    ...
    return (
      <View>
        ...
        <Modal
          animationType="fade"
          transparent={true}
          visible={this.state.iconsDropdownModalVisible}
          onRequestClose={e => {
            this.iconsDropdownModalHandler(e);
          }}
        >
          {this.renderIconsDropdownModal()}
        </Modal>
